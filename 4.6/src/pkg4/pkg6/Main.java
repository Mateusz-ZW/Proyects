...
Cuentas cuenta2 = new Cuentas("Juan Ferrández Rubio", "12345678901234567890", 1.75, 300);
 
//se crea cuenta3 como copia de cuenta1
//se ejecuta el constructor copia
Cuentas cuenta3 = new Cuentas(cuenta1);
 
//mostrar los datos de cuenta1
System.out.println("Datos de la cuenta 1");
System.out.println("Nombre del titular: " + cuenta1.getNombre());
System.out.println("Número de cuenta: " + cuenta1.getNcuenta());
...
System.out.println("Número de cuenta: " + cuenta2.getNcuenta());
...
System.out.println("Número de cuenta: " + cuenta3.getNcuenta());
