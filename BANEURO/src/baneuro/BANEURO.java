...
public class BANEURO {
    ...
    public static ArrayList<Cuenta> lista;
    public static String entidad;
    public static String oficina;
    public static String fichero="cuentas.dat";
    public static String ficheroTexto="cuentas.txt";
    ...
    public static void nuevaCuenta()
    {
        ...
        if (op == 1)
        {
            CCorriente c = new CCorriente(n,a,entidad, oficina,saldo);
            lista.add(c);
        }
        else
        {
            CAhorro c = new CAhorro(n,a,entidad,oficina,saldo);
            lista.add(c);
        }
    }
